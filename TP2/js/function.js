...
// Comprobar si el elemento loaderNum existe
const loader = document.getElementById("loaderNum");

// Verificar si loader existe antes de continuar
if (loader) {
  ...
  function startLoading() {
    let percentage = 0;
    const interval = 50; // Intervalo de actualización en milisegundos (ajusta según desees)
    ...
    const updateLoader = setInterval(() => {
      ...
      if (percentage >= 100) {
        ...
        // Cambia la opacidad del overlay después de que el proceso de carga haya terminado
        setTimeout(function() {
